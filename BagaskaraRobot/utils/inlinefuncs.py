...
from BagaskaraRobot import pbot as app
from BagaskaraRobot import arq
from BagaskaraRobot.services.keyboard import Ikb
from BagaskaraRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from BagaskaraRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from BagaskaraRobot.services.types import InlineQueryResultCachedDocument
from BagaskaraRobot.modules.info import get_chat_info, get_user_info
from BagaskaraRobot.modules.music import download_youtube_audio
from BagaskaraRobot.utils.functions import test_speedtest
from BagaskaraRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/d8530063bb68cca946cd8.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Rey_ab14musicbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Rey X Music Robot 👾](https://t.me/Rey_ab14musicbot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [ROBOT](t.me/Rey_ab14musicbot) | [REY](t.me/@Rey_ab14)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
