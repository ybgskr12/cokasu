...
from BagaskaraRobot.modules import ALL_MODULES
from BagaskaraRobot.modules.helper_funcs.chat_status import is_user_admin
from BagaskaraRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("BagaskaraRobot.modules." + module_name)
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            "\n • `/msettings` - To Settings Authorized User and Music Volume without inline button ."
