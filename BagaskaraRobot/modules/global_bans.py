...
import BagaskaraRobot.modules.sql.global_bans_sql as sql
from BagaskaraRobot.modules.sql.users_sql import get_user_com_chats
...
from BagaskaraRobot.modules.helper_funcs.misc import send_to_list
...
GBAN_HANDLER = CommandHandler("rgban", gban, run_async=True)
UNGBAN_HANDLER = CommandHandler("tungban", ungban, run_async=True)
GBAN_LIST = CommandHandler("rgbanlist", gbanlist, run_async=True)
