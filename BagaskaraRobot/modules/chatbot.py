...
import BagaskaraRobot.modules.sql.chatbot_sql as sql
from BagaskaraRobot.modules.helper_funcs.filters import CustomFilters
from BagaskaraRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from BagaskaraRobot import dispatcher, updater, SUPPORT_CHAT
from BagaskaraRobot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ʀᴇʏ ✘ ᴍᴜꜱɪᴄ Chatbot Di Matiin Djancok!! Sama {}.".format(
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ʀᴇʏ ✘ ᴍᴜꜱɪᴄ Chatbot Dah Aktif Ya Djancok by {}.".format(
                    mention_html(user.id, user.first_name)
                ),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>ʀᴇʏ ✘ ᴍᴜꜱɪᴄ Enabled Chats</b>\n"
    for chat in chats:
        try:
