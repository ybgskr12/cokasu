...
from BagaskaraRobot import telethn as bot
from BagaskaraRobot.modules.urluploader import download_file
from BagaskaraRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *BagaskaraRobot*",
            )
        except Exception as e:
            traceback.print_exc()
