...
from BagaskaraRobot.__main__ import STATS, TOKEN, USER_INFO
from BagaskaraRobot.modules.sql import SESSION
import BagaskaraRobot.modules.sql.userinfo_sql as sql
from BagaskaraRobot.modules.disable import DisableAbleCommandHandler
from BagaskaraRobot.modules.sql.global_bans_sql import is_user_gbanned
from BagaskaraRobot.modules.sql.afk_sql import is_afk, set_afk
from BagaskaraRobot.modules.sql.users_sql import get_user_num_chats
from BagaskaraRobot.modules.helper_funcs.chat_status import sudo_plus
from BagaskaraRobot.modules.helper_funcs.extraction import extract_user
from BagaskaraRobot import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. Queen Of @ybgskr. Bot Name Inspired From 'Bagaskara'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/allfucek"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/loveisfuckedup")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "❂ <b>Stats For <a href='https://t.me/Rey_ab14musicbot'>Rey X Music Robot</a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
